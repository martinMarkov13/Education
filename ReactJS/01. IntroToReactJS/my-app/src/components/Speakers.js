const Speakers = ()=>{
    return (
        ...
        <div className="col-md-4 col-sm-6 feature">
          <img src="img/speaker-1.png" className="speaker-img" alt="Sorry" />
          <h3>Simon Collins</h3>
          <p>
        ...
        <div className="col-md-4 col-sm-6 feature">
          <img src="img/speaker-2.png" className="speaker-img" alt="Sorry" />
        ...
        <div className="col-md-4 col-sm-6 feature">
          <img src="img/speaker-3.png" className="speaker-img" alt="Sorry" />
          <h3>Harry Roberts</h3>
          <p>
        ...
        <div className="col-md-4 col-sm-6 feature">
          <img src="img/speaker-4.png" className="speaker-img" alt="Sorry" />
          <h3>Geri Coady</h3>
          <p>
            Harry is a freelance designer, developer, writer, speaker and
            front-end architect from the UK, previously working as Senior UI
        ...
        <div className="col-md-4 col-sm-6 feature">
          <img src="img/speaker-5.png" className="speaker-img" alt="Sorry" />
          <h3>Andy Budd</h3>
          <p>
            Harry is a freelance designer, developer, writer, speaker and
            front-end architect from the UK, previously working as Senior UI
        ...
        <div className="col-md-4 col-sm-6 feature">
          <img src="img/speaker-6.png" className="speaker-img" alt="Sorry" />
